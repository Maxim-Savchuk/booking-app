        ...
        <div>
            <form >
                ...
                <div className='mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                    ...
                    <button className='flex justify-center items-center gap-1 border bg-transparent rounded-2xl p-2 text-2xl text-gray-600 hover:text-black hover:border-black'>
