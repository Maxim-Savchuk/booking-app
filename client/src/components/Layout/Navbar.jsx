...
const Navbar = () => {
    ...
    return (
        <header className='flex justify-between -mx-8 -my-4 py-4 px-8 border-b bg-white'>
            <Link to={'/'} className="flex items-center gap-1">
                ...
                <span className='font-bold text-xl text-primary'>Lameplane</span>
            </Link>
            <div className='flex border border-gray-300 rounded-full py-2 px-4 gap-2 shadow-md shadow-gray-300'>
                ...
                <div className='border-l border-gray-300 text-gray-500 pl-2'>Add guests</div>
            ...
            <Link to={user ? '/account' : '/login'} className='flex border border-gray-300 rounded-full py-2 px-4 gap-2'>
